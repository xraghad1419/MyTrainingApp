...
public class Adapter_Applied_CV extends RecyclerView.Adapter<Adapter_Applied_CV.MyViewHolder> {

    ArrayList<Applicant>list;
    private RecycleViewClickListener listener;

    public Adapter_Applied_CV(ArrayList<Applicant>list, RecycleViewClickListener listener)
    {
        this.list = list;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cv_applied_card,parent,false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            appImage = itemView.findViewById(R.id.image);
