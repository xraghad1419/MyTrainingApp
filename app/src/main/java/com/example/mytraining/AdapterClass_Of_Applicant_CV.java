...
public class AdapterClass_Of_Applicant_CV extends RecyclerView.Adapter<AdapterClass_Of_Applicant_CV.MyViewHolder> {

    ArrayList<Applicant>list;
    private RecycleViewClickListener listener;

    public AdapterClass_Of_Applicant_CV(ArrayList<Applicant>list, RecycleViewClickListener listener)
    {
        this.list = list;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cv_app_card,parent,false);
