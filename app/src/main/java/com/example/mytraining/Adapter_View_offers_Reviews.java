...
public class Adapter_View_offers_Reviews extends RecyclerView.Adapter<Adapter_View_offers_Reviews.MyViewHolder> {
    ...
    public Adapter_View_offers_Reviews(ArrayList<Review>list)
    {
        this.list = list;
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_offer_reviews_ch,parent,false);
